...
<style>
    ...
    .gradient {
            background: linear-gradient(90deg, #e3f2fd 0%, #98c3e2 100%);
        }
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <div class="flex justify-center">
                <img src="{{url('img/logo_gold.png')}}" alt="Vbeyond Logo" class="w-64 h-64"> <!-- ปรับขนาดตามต้องการ -->
            </div>

            <form class="space-y-4 mt-2" id="loginForm" action="{{route('loginUser')}}" method="POST">
                @csrf
                <div class="forminput">
                ...
                <div>
                    <button type="submit" class="w-full p-3 rounded-lg text-white microsoft-gradient">เข้าสู่ระบบ</button>
                ...
                {{-- <hr>
                <div>
                    <button type="button" id="loginM356" class="w-full p-3 rounded-lg text-white microsoft-gradient flex items-center justify-center"
